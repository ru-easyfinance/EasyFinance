...
switch( $action )
{
			...
			case '5':
				...
				default:
					...
					<table style='border: 1px dotted rgb(255, 96, 2); background-color: rgb(248, 248, 216); padding: 10px; width:100%;'>
						<td class=cat_add>
						<h4>Как счет вы хотите добавить?</h4>
						<select name='typeAccount' id='typeAccount' onChange='accountChangeType();'>
							...
							<option value='4'>Депозитный счет</option>
							<option value='5'>Металлический счет</option>
						</select><br><br>
						<span id='descriptionAccount'>Текст для наличного счета</span><br><br>
						<input type='button' value='Далее' onClick='accountNextStep(2);'>
	...
	case "getCurrency":
		...
		if ($currencyId != $account['currency'])
		{
			...
			$data = "
				Курс <b>".$sys_currency_name[$currencyId]."</b> к <b>".$account['currency_name']."</b> 
					...
					$data .= "
						<tr>
							<td colspan='3' class='cForm'  style='border-bottom:1px solid #cccccc;'>
								<span id='title_cForm'>Наличные</span><br>
							</td>
						</tr>
						<tr>
							<td class='head_cForm' style='padding-left: 25px; border-bottom:1px solid #cccccc;' width=20%><b>Название счета</b></td>
							<td class='head_cForm' style='padding-left: 25px; border-bottom:1px solid #cccccc;' width=15% align=right><b>Сумма</b></td>
							<td class='head_cForm' style='padding-left: 25px; border-bottom:1px solid #cccccc;' width=65%>&nbsp;</td>
						</tr>
						<!--<tr>
							<td class='cat_add' style='padding-left: 25px; border-bottom:1px solid #cccccc;'><b>Название счета</b></td>
							<td class='cat_add' align='right' style='padding-right: 15px; border-bottom:1px solid #cccccc;'><b>Сумма</b></td>						
						</tr>-->
						";
					$block = 0;
				}
			...
			if ($accounts[$i]['bill_type'] == 1)
			{
				if ($block != 1)
				{
					...
					<table border='0' cellpadding='5' cellspacing='0' width='100%'>
						<tr>
							<td colspan='3' class='cForm' style='border-bottom:1px solid #cccccc;'>
								<span id='title_cForm'>Банковские карты</span><br>
							</td>
						</tr>
						<tr>
							<td class='head_cForm' style='padding-left: 25px; border-bottom:1px solid #cccccc;' width=20%><b>Название счета</b></td>
			...
			if ($accounts[$i]['bill_type'] == 3)
			{
				if ($block != 3)
				{
					...
					<table border='0' cellpadding='5' cellspacing='0' width='100%'>
						<tr>
							<td colspan='3' class='cForm' style='border-bottom:1px solid #cccccc;'>
								<span id='title_cForm'>Долговые счета</span><br>
							</td>
						</tr>
						<tr>
							<td class='head_cForm' style='padding-left: 25px; border-bottom:1px solid #cccccc;' width=20%><b>Название счета</b></td>
					...
					<table border='0' cellpadding='5' cellspacing='0' width='100%'>
						<tr>
							<td colspan='5' class='cForm' style='border-bottom:1px solid #cccccc;'>
								<span id='title_cForm'>Депозитные счета</span><br>
							</td>
						</tr>
						<tr>
							<td class='head_cForm' style='padding-left: 25px; border-bottom:1px solid #cccccc;'><b>Название счета</b></td>
							<td class='head_cForm' style='padding-left: 25px; border-bottom:1px solid #cccccc;' align=right><b>Сумма</b></td>
							<td class='head_cForm' style='padding-left: 25px; border-bottom:1px solid #cccccc;'><b>Банк</b></td>
							<td class='head_cForm' style='padding-left: 25px; border-bottom:1px solid #cccccc;'><b>% ставка</b></td>
							<td class='head_cForm' style='padding-left: 25px; border-bottom:1px solid #cccccc;'><b>Дата открытия</b></td>
						</tr>
						<!--<tr>
							<td class='cat_add' style='padding-left: 25px; border-bottom:1px solid #cccccc;'><b>Iacaaiea n?aoa</b></td>
							<td class='cat_add' align='right' style='padding-right: 15px; border-bottom:1px solid #cccccc;'><b>Noiia</b></td>						
