...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="'.$this->Context->GetDefinition('XMLLang').'">
	<head>
		<title>'.$this->Context->PageTitle.' - '.$this->Context->Configuration['APPLICATION_TITLE'].'</title>
		...
		if (is_array($this->Scripts)) {
			...
			for ($i = 0; $i < $ScriptCount; $i++) {
				...
				<script type="text/javascript" src="'.$this->Context->Configuration['DEFAULT_STYLE'].'clear.js"></script>';
			}
		}
