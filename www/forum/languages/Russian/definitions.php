...
$Context->Dictionary['YourFirstNameNotes'] = 'Ваше имя на форуме. Может быть настоящим или вымышленным.';
$Context->Dictionary['YourLastNameNotes'] = 'Фамилия. Если что, её указывать не обязательно<br/>';
