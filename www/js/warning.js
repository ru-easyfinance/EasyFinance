...
var msg1 = "Просим обновить Ваш браузер для работы с EasyFinance.ru";
var msg2 = "Просим Вас обновить используемый Вами браузер Internet Explorer 6, так как он не поддерживает многие технологии, используемые сайтом, но их поддерживают все более новые браузеры. Ниже представлены самые популярные современные браузеры.";
var msg3 = "Установка любого из указанных браузеров проста и безопасна - просто щелкните на значке выбранного браузера для начала загрузки.";
var br1 = "Internet Explorer 7+";
var br2 = "Firefox 3+";
var br3 = "Safari 3+";
var br4 = "Opera 9.5+";
var br5 = "Chrome 2.0+";
var url1 = "http://www.microsoft.com/rus/windows/default.mspx";
var url2 = "http://www.mozilla-europe.org/ru/firefox/";
