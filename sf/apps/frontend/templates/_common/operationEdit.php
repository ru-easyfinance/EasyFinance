            ...
            <div class="line periodic event hidden" id="operationEdit_weekdays">
                ...
                <div class="cell">
                    <table class="week">
                        <tbody>
                            <tr>
                                <td><label for="cal_mon">Пн</label></td>
                                <td><label for="cal_tue">Вт</label></td>
                                <td><label for="cal_wed">Ср</label></td>
                                <td><label for="cal_thu">Чт</label></td>
                                <td><label for="cal_fri">Пт</label></td>
                                <td><label for="cal_sat">Сб</label></td>
                                <td><label for="cal_sun">Вс</label></td>
                            </tr>
                            <tr>
                                <td><input type="checkbox" value="1" id="cal_mon" name="mon" /></td>
                                <td><input type="checkbox" value="1" id="cal_tue" name="tue" /></td>
                                <td><input type="checkbox" value="1" id="cal_wed" name="wed" /></td>
                                <td><input type="checkbox" value="1" id="cal_thu" name="thu" /></td>
                                <td><input type="checkbox" value="1" id="cal_fri" name="fri" /></td>
                                <td><input type="checkbox" value="1" id="cal_sat" name="sat" /></td>
                                <td><input type="checkbox" value="1" id="cal_sun" name="sun" /></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
