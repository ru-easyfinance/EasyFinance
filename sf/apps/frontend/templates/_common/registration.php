<div id="registration" class="formRegister" >
    ...
    <form id="formRegister">
        ...
        <tr>
            <td></td>
            <td><br/>Нажимая на кнопку &laquo;Отправить&raquo; Вы подтверждаете свое согласие с условиями <a href="https://{$smarty.const.URL_ROOT_WIKI}tiki-view_blog_post.php?postId=41">договора оферты</a>.<br/>
