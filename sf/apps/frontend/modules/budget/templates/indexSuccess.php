...
<div class="ramka3">
    ...
    <div id="budget" class="inside budget">
        <div class="addbudget"><a href="#master" id="btnBudgetWizard" class="efTooltip" title="Создать новый или отредактировать уже существующий бюджет">Мастер создания и редактирования бюджета</a></div>
        ...
        <div class="budget list">
            ...
            <div class="timeline" style="position: relative; left: 164px; width: 64px; height: 20px; padding-top: 10px; ">
                <div style="position: absolute; left: -10px; width: 20px;">1</div>
                <div class="budgetPeriodEnd" style="position: absolute; left: 70px; width: 60px;">загрузка...</div>
...
<div id="master" class="budget" style="display: none">
    ...
    <div id="step1" class="step">
        ...
        <div class="master body">
            ...
            <p class="copy">Месяц, с которого нужно cкопировать бюджет</p>
            <p class="copy">
