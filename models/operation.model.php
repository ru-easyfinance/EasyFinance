...
class Operation_Model {
     ...
     * @return array mixed
     */
    function getOperationList($dateFrom, $dateTo, $currentCategory, $currentAccount, $type, $sumFrom, $sumTo, $search_field)
    {
        if ($sumTo == 0) {
            $sumTo = null;
        }
        ...
        $sql = "SELECT o.id, o.user_id, o.money, DATE_FORMAT(o.date,'%d.%m.%Y') as `date`, o.date AS dnat,
            ...
            FROM operation o
            WHERE (o.comment LIKE '%$search_field%' OR o.tags LIKE '%$search_field%') AND o.user_id = " . Core::getInstance()->user->getId();
