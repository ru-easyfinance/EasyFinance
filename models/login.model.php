...
class Login_Model
{
    ...
    {
        $body = "<html><head><title>Успешная регистрация в сервисе управления личными финансами EasyFinance.ru</title></head>
        <p>Здравствуйте!</p>
        <p>Поздравляем вас с успешным завершением регистрации в сервисе. Теперь вы можете в любое время войти в сервис, введя свой логин и пароль на сайте easyfinance.ru.</p>
        ...
        <ul>
            ...
            <li>Если вам понадобится дополнительная информация о работе с сервисом, воспользуйтесь разделом меню Инструкции.</li>
            <li>Если у вас возникнут какие-то сложности в работе с сервисом, обратитесь за помощью в службу поддержки support@easyfinance.ru.</li>
        </ul>
        <p>C уважением,<br/>Администрация сервиса EasyFinance.ru</p>
        ...
        <p>Здравствуйте!</p>
        <p>Поздравляем вас с успешным завершением регистрации в системе. Теперь вы можете в любое время войти в систему, введя свой логин и пароль на сайте easyfinance.ru.</p>
        <p>Используйте наш сервис для контроля своей домашней бухгалтерии.</p>
        <p>Мы надеемся, что с помощью EasyFinance.ru Вам будет удобно планировать и контролировать ваш личный и семейный бюджет, принимать на основе объективной информации взвешенные решения, вносить коррективы в свой финансовый план.</p>
        <p>Отслеживайте динамику своих расходов и доходов, анализируйте рациональность личных и семейных трат с сайтом для ведения домашней бухгалтерии EasyFinance.ru.</p>
        <p>Контролируйте состояние своих финансов и семейный бюджет круглосуточно из любой точки мира – с рабочего места, из кафе, даже из машины. Все, что для этого нужно, – доступ в Интернет и компьютер.</p>
        ...
        <a href='http://www.easyfinance.ru'>www.easyfinance.ru</a>";
         ...
         $message = Swift_Message::newInstance()
            // Заголовок
            ->setSubject('Успешная регистрация в сервисе управления личными финансами EasyFinance.ru')
            // Указываем "От кого"
