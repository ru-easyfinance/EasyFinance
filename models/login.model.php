...
class Login_Model
{
    ...
    private static function _sendRegistrationLetter()
    {
        ...
        <p>Здравствуйте!</p>
        <p>Поздравляем вас с успешным завершением регистрации в сервисе. Теперь вы можете в любое время войти в сервис, введя свой логин и пароль на сайте https://easyfinance.ru.</p>
