...
class Login_Model
{
    ...
    function defaultCategory() {
        ...
        (0, {$uid}, 3,  'Дети', -1, NOW()),
        (0, {$uid}, 4,  'Домашнее хозяйство', 0, NOW()),
        ...
        (0, {$uid}, 18, 'Расходы по работе', 0, NOW()),
    ...
    function activate_user() {
        ...
        if (count($user->getUserCategory()) == 0) {
            ...
            в любое время войти в систему, введя свой логин и пароль на сайте www.easyfinance.ru.</p>
            <p>Используйте наш сервис для контроля своей домашней бухгалтерии.</p>
            <p>Мы надеемся, что с помощью EasyFinance.ru Вам будет удобно планировать и контролировать
            ...
            трат с сайтом для ведения домашней бухгалтерии EasyFinance.ru.</p>
            ...
            компьютер или мобильный телефон - сервис EasyFinance.ru  доступен с мобильных телефонов и
            коммуникаторов (специальная PDA версия). Для доступа в PDA версию просто наберите EasyFinance.ru
            в браузере Вашего коммуникатора или телефона (сервис распознает PDA режим автоматически).</p>
            <p>Кроме личного бюджета с помощью EasyFinance.ru Вы можете контролировать состояние финансов
            ...
            поддержки support@easyfinance.ru.</li>
            </ul>
