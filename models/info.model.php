        ...
        self::$_advices = array(
            ...
            Tahometer::$BUDGET_KEYWORD => 
                array(
                    ...
                    2 => array(
                            0 => "Сохраняйте темпы экономии, если месяц еще не закончился<br/><br/>Если у Вас нет финансового резерва, начните откладывать деньги в страховой резерв<br/><br/>",
                            1 => "Сохраняйте темпы экономии, если месяц еще не закончился<br/><br/>Если у Вас нет финансового резерва, начните откладывать деньги в страховой резерв<br/><br/>",
                            2 => "Сохраняйте темпы экономии, если месяц еще не закончился<br/><br/>Если у Вас нет финансового резерва, начните откладывать деньги в страховой резерв<br/><br/>"
                        )
                ),
            Tahometer::$LOANS_KEYWORD => 
                array(
                    ...
                    2 => array(
                            0 => "У Вас все еще достаточный уровень финансовой независимости<br/><br/>Но Вы приближаетесь к границе нормативного уровня<br/><br/>Не берите больше кредиты/займы без необходимости<br/><br/>",
