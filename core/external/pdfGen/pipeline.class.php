...
class Pipeline {
  ...
  function close() {
    $this->_dispatcher->fire("after-batch", $this);
  ...
  function _show_item(&$box, $offset, &$context, &$media, &$postponed_filter) {
    ...
    $this->_dispatcher->fire("before-document", $this, $box);
    ...
    for ($i=0; $i<$expected_pages; $i++) {
      ...
      $this->_dispatcher->fire("before-page", $this, $box, $i);
      ...
      $this->_dispatcher->fire("after-page", $this, $box, $i);
    ...
    $this->_dispatcher->fire("after-document", $this, $box);
  }
  ...
  function process_batch($data_id_array, &$media) {
    ...
    $this->_dispatcher->fire("before-batch", $this);
