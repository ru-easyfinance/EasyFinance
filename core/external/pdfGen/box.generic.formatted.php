<?php
// $Header: /cvsroot/html2ps/box.generic.formatted.php,v 1.18 2006/12/24 14:42:43 Konstantin Exp $
...
class GenericFormattedBox extends GenericBox {
  ...
  function check_page_break_after(&$parent, &$context) {
    ...
    $page_break_after = $this->getCSSProperty(CSS_PAGE_BREAK_AFTER);
    if ($page_break_after != PAGE_BREAK_AVOID &&
        $page_break_after != PAGE_BREAK_AUTO) {
