...
class WCNone extends WidthConstraint {
  ...
  function _copy() { return new WCNone(); }
  function _units2pt($base) { return; }
...
class WCConstant extends WidthConstraint {
  ...
  function _copy() { return new WCConstant($this->width); }
...
class WCFraction extends WidthConstraint {
  ...
  function _copy() { return new WCFraction($this->fraction); }
  function _units2pt($base) { }
