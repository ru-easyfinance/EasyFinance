<?php
// $Header: /cvsroot/html2ps/output._generic.class.php,v 1.9 2006/10/06 20:10:53 Konstantin Exp $
...
class OutputDriverGeneric extends OutputDriver {
  ...
  function getPageBottom() {
    return $this->getFootnoteTop();
  }

  function getFootnoteTop() {
    return round($this->offset + $this->getFootnoteAreaHeight() + mm2pt($this->media->margins['bottom']),2);
  }
