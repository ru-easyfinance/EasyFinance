<?php
// $Header: /cvsroot/html2ps/box.table.php,v 1.57 2006/12/24 14:42:43 Konstantin Exp $
...
class TableBox extends GenericContainerBox {
  ...
  function table_columns_fit($width, &$context) {
    ...
    $cellpadding = $this->getCSSProperty(CSS_HTML2PS_CELLPADDING);
    $cellspacing = $this->getCSSProperty(CSS_HTML2PS_CELLSPACING);
    ...
    $this->put_full_width(array_sum($widths));
  ...
  function reflow_absolute(&$context) {
    $this->reflow_static_normal($this->get_parent_node(), $context);
