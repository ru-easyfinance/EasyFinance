<?php
// $Header: /cvsroot/html2ps/html.attrs.inc.php,v 1.60 2006/10/15 08:59:18 Konstantin Exp $
...
function attr_border_before(&$root, &$pipeline) {
  ...
  $handler =& CSS::get_handler(CSS_BORDER);
  $border = $handler->get($css_state->getState());
  ...
  $handler->replace($border, $css_state);
}
