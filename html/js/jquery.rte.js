...
jQuery.fn.rte = function(css_url, media_url) {
    ...
    function toolbar(iframe) {
        ...
        var tb = $("<div class='rte-toolbar' id='toolbar-"+iframe.title+"'><div>\
            ...
            <p>\
                <a href='#' class='bold'><img src='i/bold.gif' alt='bold' /></a>\
                <a href='#' class='italic'><img src='i/italic.gif' alt='italic' /></a>\
            </p>\
            <p>\
                <a href='#' class='unorderedlist'><img src='i/unordered.gif' alt='unordered list' /></a>\
                <a href='#' class='link'><img src='i/link.png' alt='link' /></a>\
                <a href='#' class='image'><img src='i/image.png' alt='image' /></a>\
                <a href='#' class='disable'><img src='i/close.gif' alt='close rte' /></a>\
            </p></div></div>");
        ...
        $('.disable', tb).click(function() {
            ...
            var edm = $('<a href="#">Включить визуальное форматирование</a>');
            tb.empty().append(edm);
            edm.click(function(){
